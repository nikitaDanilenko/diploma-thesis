...
Da $f_Z$ und $-f_Z$ integrierbar und nach~\ref{MessbarkeitVonExtremaInGordonschenPaaren} die Abbildungen
...
$\mfa-\mfb$--messbar und nach~\ref{ErwartungswertDer2NormEinesStandardnormalverteiltenProzesses} sind diese
...
$T'\coloneqq  \meng 0$, sowie $V''\coloneqq  \menge{\pfeil \varphi N (x)}{\varphi \in \kabg{E'}01}$.\\
Wegen
\[\forall\, \varphi \in \kabg{E'}01: \abs{\pfeil\varphi N (x)}
...
\sup_{\varphi \in \kabg{E'}01}\varphi\left(\bprod{\gamma(\omega)}x_N \right)\\
\overset{\refclaim{EigenschaftenDesLinearkombinators}
{EigenschaftenDesLinearkombinators2}}= &\,
\sup_{\varphi \in \kabg{E'}01}\sprod{\gamma(\omega)}{\pfeil \varphi N (x)}_N
...
$\mfa-\mfb$--messbar und nach~\ref{ErwartungswertDer2NormEinesStandardnormalverteiltenProzesses}
...
Sei $V''\coloneqq  \menge{\pfeil \varphi N(x)}{\varphi \in \kabg{E'}01}$.\\
...
=\sup_{\varphi \in \kabg{E'}01}\sprod{g(\omega)s}{\pfeil\varphi N (x)}_N\\
&\overset{\refclaim{EigenschaftenDesLinearkombinators}
{EigenschaftenDesLinearkombinators2}}=
\sup_{\varphi \in \kabg{E'}01}\varphi\left(\bprod{g(\omega)s}x_N \right)
