...
quadratintegrierbar.\\
(2) Da $\gamma, \delta$ vollständig unabhängig und zentriert sind, gilt
...
damit linear unabhängig. Damit gilt:
\begin{align*}
...
\end{align*}
(3) Weil $\widetilde g$ unabhängig und zentriert ist, sind die
Komponentenfunktionen von $\widetilde g$ und damit auch jene von $g$ paarweise
orthogonal, also linear unabhängig. Somit folgt wie im Beweis von (1):
\begin{align*}
...
& \iff  t= 0 \vee v = 0\text.
\end{align*}
(4)/(5) Sind $X_1,X_2$ stochastisch unabhängige Zufallsgrößen, $a_1,a_2\in \R$
und $\sigma_1,\sigma_2\in\R_{>0}$ derart, dass $X_i$
$N(a_i,\sigma_i^2)$--verteilt sind für alle $i \in \haken 2$, so ist nach~\cite{Irle} (dort 10.15) $X_1 + X_2$
