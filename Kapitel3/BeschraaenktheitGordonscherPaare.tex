\begin{lemma}{Beschr‰nktheit Gordon'scher Paare}
             {BeschraenktheitGordonscherPaare}
Seien $c \in \R$ und $(X, Y)$ das Gordon'sche Paar zu $(\gamma,\delta,g,c)$.\\
Seien $\emptyset \neq T \subseteq \R^m$ beschr‰nkt,
$\emptyset \neq V \subseteq \R^N$ beschr‰nkt und $\omega \in \Omega$.\\
Dann gilt:
\begin{enumerate}[(1)]
	...
	$\menge{Y(t, v)(\omega)}{t \in T, v \in V}$ beschr‰nkt.
...
\end{enumerate}
\end{lemma}
\begin{proof} Da $T$ beschr‰nkt ist, gibt es ein $a \in \R_{>0}$ mit 
$\forall\, t \in T: \norm t_{2, m} \le a$ und da auch $V$ beschr‰nkt ist, gibt
...
beiden genannten Mengen beschr‰nkt.\\
(2) Folgt unmittelbar aus der Beschr‰nktheit der in (1) angegebenen Mengen.\\
