...
Schließlich seien $\mct \coloneqq  \Pot_{ne}(T)$ und $\mcv \coloneqq  \Pot_{ne}(V)$.\\
Dann gilt:
\begin{enumerate}[(1)]
...
\end{align*}
Damit erfüllen $X', Y'$ alle Voraussetzungen von~\ref{GaussscherMinMaxSatzGleichheitInDerErstenBedingung}, sodass gilt:
\begin{align*}
