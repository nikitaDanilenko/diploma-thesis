...
\newcommand{\Kern}   {\mathop{\textrm{Kern}}\nolimits}   % kernel
\newcommand{\Bild}   {\mathop{\textrm{Bild}}\nolimits}   % range
\newcommand{\Inn}    {\mathop{\textrm{int}}\nolimits}    % interior
\newcommand{\sgn}    {\mathop{\textrm{sgn}}\nolimits}    % sign
\newcommand{\Pot}    {\mathop{\textrm{Pot}}\nolimits}    % power set
\newcommand{\Hom}    {\mathop{\textrm{Hom}}\nolimits}    % homomorphisms
\newcommand{\Inv}    {\mathop{\textrm{Inv}}\nolimits}    % units
\newcommand{\inv}    {^{-1}}                             % to the power of -1
\newcommand{\Mat}    {\mathop{\textrm{Mat}}\nolimits}
\newcommand{\pr}     {\mathop{\textrm{pr}}\nolimits}

\newcommand{\erf}{\mathop{\textrm{erf}}\nolimits}
...
% \varepsilon looks great, but is way to long
