...
% Usepackage section                                                          %
%                                                                             %
% Includes several packages for certain fonts, commands, symbols etc.         %
%                                                                             %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Automatically create a nice index. Maybe redundant in small files.
%\makeindex

% An environment for simple typesetting of cyrillic letters.
...
% Double stroked C for complex numbers
