...
\end{align}
Seien $\Omega_1:=\!\ ]0,1[$, $\mfc := \Pot(]0,1[)\: \cap\: \mfb$ und
$\Prim_1:=\lambda\vert_{\mfc}$, wobei $\lambda$ das eindimensionale Lebesguemaß
bezeichne.\\
Sei $t \in \R$.\\
Dann ist
...
gefunden.\absatz
(2) Seien $\Omega_2:=\!\ ]0,1[^n$, $\mfd:=\Pot\left(]0,1[^n\right) \cap \mfb_n$
und $\Prim_2:= \lambda_n\vert_\mfd$, wobei $\lambda_n$ das $n$--dimensionale
...
%(1) Seien zunächst $\Omega_1:=]0,1[$, $\mfc := \Pot(]0,1[) \cap \mfb$ und
%$\Prim_1:=\lambda\vert_{\mfc}$, wobei $\lambda$ das eindimensionale %Lebesguemaß
%bezeichne.\\
%Seien $p \in ]0, 1[$ und $M_p:=\menge{x \in \R}{F(x) \ge p}$.\\
