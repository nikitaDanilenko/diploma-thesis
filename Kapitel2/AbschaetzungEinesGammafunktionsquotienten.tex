\begin{lemma}{Abschätzung eines Gammafunktionsquotienten}
...
\begin{proof}
Nach~\refclaim{ElementareEigenschaftenDerGammafunktion}
{ElementareEigenschaftenDerGammafunktion1} ist für alle $n \in \N$: 
$\Gamma\left(\frac n 2 \right) > 0$ und $\Gamma(\frac{n+1}2)> 0$.\\
Daher ist für alle $n \in \N$: $a_n > 0$.\\
...
\end{align*}
(2)/(4) Sei $n \in \N$.\\
Dann gibt es nach ~\refclaim{ExistenzFVerteilterZufallsgroessen}
{ExistenzFVerteilterZufallsgroessen2}  einen Wahrscheinlichkeitsraum
$(\Omega', \mfa', \Prim')$ und ein
$\gamma: \Omega' \rightarrow \R^n$ unabhängig und $N(0, 1)$--verteilt.\\
Nach~\ref{ErwartungswertDer2NormEinesStandardnormalverteiltenProzesses} gilt
dann $\E\left(\norm\cdot_{2, n} \circ \gamma \right) = a(n)$.\\
Da $\gamma$ unabhängig und $N(0,1)$--verteilt ist, ist es auch
...
Außerdem gilt nach~\refclaim{AequivalenzkonstantenFuerPNormen}
...
\circ \gamma$ und nach~\ref{ErwartungswertDer2NormEinesStandardnormalverteiltenProzesses} ist
