...
\end{satz}
\begin{proof}
Seien $\mcp\coloneqq  \Pot_{ne}(I \times J)$ und $(i_0, j_0) \in I \times J$.\\
...
Zusammen mit (a) sind damit die Voraussetzungen von~\ref{EndlicheDarstellungDesSupremumsIntegrierbarerFunktionen} für die Familie
$(Y(i,j))_{(i,j) \in I \times J}$ erfüllt. Also ist
\[M_1\coloneqq \menge{\E\left(\sup_{(i, j) \in P}Y(i,j) \right)}{P \in \mcp}\]
...
\end{align}
Sei nun 
\[M_2 \coloneqq  \menge{\E\left(\sup_{i \in A}\sup_{j \in B}Y(i,j) \right)}
