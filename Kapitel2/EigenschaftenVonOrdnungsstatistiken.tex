...
\begin{enumerate}[(1)]
	...
	$\gamma_k^\ast = \gamma^\sigma_k$. Ist $\gamma$ unabhängig, so ist auch
	...
	Ist $\gamma$ unabhängig und identisch verteilt,
	so gilt:
	...
	Ist $\gamma$ unabhängig und identisch verteilt, sodass $\gamma_1$ eine
...
Für die zweite seien $(A_i)_{i \in \haken n} \in \mfb^n$. Da die Abbildung
$f:\R \rightarrow \R, x \mapsto -x$ stetig und damit messbar ist, ist
$-A_i = f\inv(A_i) \in \mfb$ für alle $i \in \haken n$. Also gilt:
\begin{align*}
...
\end{align*}
(3)/(4) Siehe~\cite{AB}, dort 2.2.13 für die Verteilung und 2.2.2 für die
