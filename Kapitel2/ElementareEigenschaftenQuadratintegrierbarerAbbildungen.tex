...
$L_2(\Omega, \mfa, \Prim, \R)$, die zweite folgt aus der Forderung, dass für
...
Da $\gamma$ messbar,
$\norm\cdot_{2, n}$ stetig bezüglich sich selbst, $q: \R \rightarrow \R,
t\mapsto t^2$ stetig sind und auf $\R$ die Borel'sche $\sigma-$Algebra
vorliegt, sind $Y$ und $\sqrt\cdot \circ Y$ als Hintereinanderausführung
