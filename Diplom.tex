...
unabhängig.
Sei weiter $g:= \Mat_{m,N} \circ \widetilde g$.\\
...
eben bewiesenen Lemma können diese einfach bestimmt werden.
...
$c := 1$ die anderen Voraussetzungen offensichtlich gegegeben sind, aber
...
abbilden, dass alle Bilder "`fast"' normiert sind.
...
Der Grund für diese Abschwächung ist der, dass die "`Größe"' der Menge sich nicht ohne den Gauß'schen Operator auf
