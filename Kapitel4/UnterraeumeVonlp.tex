...
und damit sind die Voraussetzungen von~\ref{ExistenzFastIsometrischerAbbildungen} erfüllt.\\
Die Aussage (1) ist genau die Aussage von~\ref{ExistenzFastIsometrischerAbbildungen}.\\
(2) Es gelte $p=\infty$ und $m \le \eps^2 \log(n)$.\\
Seien $(E,\norm\cdot_E)\coloneqq \ell_\infty^n$, $T\coloneqq S^{m-1}$, $x\coloneqq  (e_i^n)_{i=1}^n$,
\[\bigg((\Omega, \mfa, \Prim), (\gamma,\delta,\widetilde g),(n, m, mn)\bigg)
\text{ ein }(N(0,1), 3)\text{--Tupel zu }(3,(n,m,mn))\] (existiert nach~\ref{ExistenzNormalNTupel}) und $(Z_{\gamma, x}, M_{\delta_T})$ das
...
\end{align*}
Wegen $(a), (b), (c)$ sind die Voraussetzungen von~\ref{ExistenzEingeschraenkterFastIsometrien} erfüllt und wegen
$T = S^{m-1}$ gibt es 
