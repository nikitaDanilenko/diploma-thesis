...
\tag{$c$}
\end{align*}
Mit $(a),(b),(c)$ sind die Voraussetzungen von~\ref{ExistenzEingeschraenkterFastIsometrien} erfüllt, also existiert wegen
...
\begin{align}\opnorm A {\ell_2^m}E\opnorm{A\inv}{A(\ell_2^m)}{\ell_2^m} \overset{~\ref{ExistenzEingeschraenkterFastIsometrien}.(3')} \le
