...
\text{ ein }(N(0,1), 4)\text{--Tupel zu }(4,\alpha)\end{align*}
 (existiert nach~\ref{ExistenzNormalNTupel}), sowie $(Z_{\gamma, x}, M_{\delta, T})$ das
Auswertungspaar zu $(\gamma, \delta, x, T)$.\\
Für jedes $s \in T$ ist die Abbildung $\bprod s \delta_m$ nach
...
$\sigma_i\coloneqq 1$ für alle $i \in \haken k$) gilt daher
...
\end{align*}
Wegen $(a), (b), (c)$ sind die Voraussetzungen von~\ref{ExistenzEingeschraenkterFastIsometrien} erfüllt und daher existiert ein
