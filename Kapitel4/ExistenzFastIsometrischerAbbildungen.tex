...
Nach~\ref{NormaequivalenzbasisImEndlichdimensionalen} existiert eine Basis
$x \in E^n$ mit
...
\end{align*}
Wegen $(a), (b), (c)$ sind die Voraussetzungen von~\ref{ExistenzEingeschraenkterFastIsometrien} erfüllt und wegen $T = S^{m-1}$
