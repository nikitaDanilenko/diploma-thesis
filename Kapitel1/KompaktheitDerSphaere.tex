\begin{lemma}{Kompaktheit der Sphäre}{PraekompaktheitDerSphaere}
...
Sei nun $K\coloneqq [0,1] \times \kran E01$ mit der Produktmetrik ausgestattet.\\
...
Ist $F\neq0$, so existiert nach Hahn--Banach ein $\varphi\in F'\setminus\meng 0$.\\
Sei $\Phi: F \rightarrow L(E,F), y \mapsto (x \mapsto \varphi(x)y)$.\\
Offensichtlich ist $\Phi$ linear und wegen $\varphi \neq 0$ auch injektiv.\\
