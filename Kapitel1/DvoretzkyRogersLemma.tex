...
Leider enthält die dortige Abschätzung in der letzten Zeile einen kleinen
Fehler, der aber wie folgt (gemäß dem ursprünglichen Beweis von Dvoretzky und
Rogers, vgl. \cite{DR}) behoben werden kann (die Notation lehnt sich an jene
aus \cite{Kad} an):
\begin{quote}
Sei $i \in \haken m$ mit $i+1 \in \haken m$ und die Behauptung gelte für alle
$k \le i$.\\
...
\end{align*}
\end{quote}
Dies liefert genau die für den Beweis benötigte Aussage.
\end{proof}