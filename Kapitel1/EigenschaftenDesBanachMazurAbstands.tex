...
Dann existiert $\vi : E \rightarrow F$ linear, stetig und bijektiv mit
$\norm \cdot _F \circ \vi = \norm\cdot _E$.\\
Da $\vi$ insbesondere eine bijektive Isometrie ist, ist auch $\vi\inv$ stetig
und es gilt $\norm\cdot_F = \norm\cdot_E \circ \vi \inv$.\\
Somit ist $\vi \in \Inv(E, F)$ und es ist $\opnorm \vi E F = 1$, sowie
$\opnorm {\vi\inv} F E = 1$.
Also
\[d_{BM}\bigg((E, \norm\cdot_E), (F, \norm\cdot_F)\bigg)
\le \opnorm \vi E F \opnorm {\vi\inv} F E = 1\text.\]
