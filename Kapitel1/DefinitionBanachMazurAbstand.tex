...
Durch oben erwähnte Festsetzung $\inf \emptyset = \infty$ ist $d_{BM}$ für je
zwei normierte Räume sinnvoll erklärt.\\
Ist $\Inv(E, F) \neq \emptyset$, so heißt ein $T \in \Inv(E, F)$ \textbf{Banach--Mazur--Abbildung zwischen $(E, \norm\cdot_E)$ und 
$(F, \norm\cdot_F)$}
\[:\iff \opnorm T E F = 1 \quad \wedge \quad 
\opnorm {T\inv} F E 
 = d_{BM}\left( (E, \norm\cdot_E), (F, \norm\cdot_F) \right)\text.\]
Insbesondere gilt also für eine Banach--Mazur--Abbildung $T$:
